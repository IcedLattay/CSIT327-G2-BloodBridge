...
urlpatterns = [
    ...
    path('notifications/get-active/', views.get_active_notifications, name='get-active-notifications'),
    path('notifications/count-unseen/', views.get_unseen_notifications_count, name='count-unseen-notifications'),
    path('notifications/set-to-seen/', views.set_unseen_to_seen, name='set-to-seen'),
    path('notifications/mark-read/<int:notif_id>/', views.mark_read, name='mark-notification-read'),
    path('appointments/<int:request_id>/cancel/', views.cancel_user_request, name='cancel_appointment'),
    path('appointments/<int:request_id>/approve/', views.approve_user_request, name='approve_appointment'),
